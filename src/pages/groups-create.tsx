...
interface GroupsCreateProps extends RouteComponentProps {}

const GroupsCreate: FC<GroupsCreateProps> = (props: GroupsCreateProps): JSX.Element => {
  ...
  const createGroup = async (e: any): Promise<void> => {
    ...
    try {
      ...
      setGroupName('');
      setGroupDesc('');
      props.history.push('/groups/owned');
    } catch (err) {
...
export default withRouter(GroupsCreate);
